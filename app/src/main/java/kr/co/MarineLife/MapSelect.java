...
//        final List<String> selectedItems = new ArrayList<String>();
        ...
        btnDialog1.setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(MapSelect.this);
                dialog  .setTitle("연도를 선택하세요")
                        ...
                        .setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    Toast.makeText(MapSelect.this, items[selectedIndex[0]], Toast.LENGTH_SHORT).show();
        ...
        btnDialog2.setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) {
                if(year=="2019") {
                    ...
                    AlertDialog.Builder dialog_ = new AlertDialog.Builder(MapSelect.this);
                    dialog_  .setTitle("월을 선택하세요")
                            ...
                            .setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    Toast.makeText(MapSelect.this, items_[selectedIndex_[0]], Toast.LENGTH_SHORT).show();
                ...
                new Button.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        if(year == null || year =="연도" || month == null || month=="월") {
                            AlertDialog.Builder alert = new AlertDialog.Builder(MapSelect.this);
